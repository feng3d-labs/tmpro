...
(function (tmpro) {
    class VertexGradient {
        ...
        VertexGradient(color0, color1, color2, color3) {
            this.topLeft = color0;
...
var tmpro;
(function (tmpro) {
    class TMP_Text extends feng3d.Component {
        constructor() {
            super(...arguments);
            /**
             ...
             */
            this.text = "New Text";
            this.isRightToLeftText = false;
            /**
             * The material to be assigned to this text object. An instance of the material will be assigned to the object's renderer.
             */
            this.fontMaterial = feng3d.Material.getDefault("TextMeshPro-Material");
            /**
             * Styles to apply to the text such as Bold or Italic.
             */
            this.fontStyle = tmpro.FontStyles.Normal;
            /**
             ...
             */
            this.colorGradientPreset = new tmpro.TMP_ColorGradient();
            /**
             * The gradient color applied over the Vertex Color. Can be locally set or driven by a Gradient Asset.
             */
            this.colorGradient = new tmpro.VertexGradient(new feng3d.Color4(1, 1, 1, 1));
            /**
             * Whether the color settings override the <color> tag.
             */
            this.overrideColorTags = false;
            /**
             ...
             */
            this.textAlignment = tmpro.TextAlignmentOptions.TopLeft;
            /**
             *
             */
             ...
             */
            this.overflowMode = tmpro.TextOverflowModes.Overflow;
            /**
             * Horizontal UV mapping when using a shader with a texture face option.
             */
            this.horizontalMapping = tmpro.TextureMappingOptions.Character;
            /**
             * Vertical UV mapping when using a shader with a texture face option.
             */
            this.verticalMapping = tmpro.TextureMappingOptions.Character;
            /**
             * The space between the text and the edge of its container.
             */
            this.margin = new feng3d.Vector4(0, 0, 0, 0);
            /**
             ...
             */
            this.useMaxVisibleDescender = true;
            /**
...
(function (tmpro) {
    ...
    let TextMeshProUGUI = class TextMeshProUGUI extends tmpro.TMP_Text {
    };
