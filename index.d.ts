...
declare namespace tmpro {
    ...
    class TextMeshProDistanceFieldUniforms {
        ...
        _FaceTex: feng3d.Texture2D<feng3d.Texture2DEventMap>;
        _FaceTex_ST: feng3d.Vector4;
        _FaceUVSpeedX: number;
        _FaceUVSpeedY: number;
        _OutlineSoftness: number;
        _FaceDilate: number;
        _OutlineColor: feng3d.Color4;
        _OutlineTex: feng3d.Texture2D<feng3d.Texture2DEventMap>;
        _OutlineTex_ST: feng3d.Vector4;
        _OutlineUVSpeedX: number;
        _OutlineUVSpeedY: number;
        _OutlineWidth: number;
        _UnderlayColor: feng3d.Vector4;
        _UnderlayOffsetX: number;
        _UnderlayOffsetY: number;
        _UnderlayDilate: number;
        _UnderlaySoftness: number;
        _Bevel: number;
        _BevelOffset: number;
        _BevelWidth: number;
        _BevelRoundness: number;
        _BevelClamp: number;
        _LightAngle: number;
        _SpecularColor: feng3d.Vector4;
        _SpecularPower: number;
        _Reflectivity: number;
        _Diffuse: number;
        _Ambient: number;
        _BumpMap: feng3d.Texture2D<feng3d.Texture2DEventMap>;
        _BumpFace: number;
        _BumpOutline: number;
        _ReflectFaceColor: feng3d.Vector4;
        _ReflectOutlineColor: feng3d.Vector4;
        s_skyboxTexture: feng3d.TextureCube<feng3d.TextureCubeEventMap>;
        _EnvMatrixRotation: feng3d.Vector4;
        _GlowColor: feng3d.Vector4;
        _GlowOffset: number;
        _GlowInner: number;
        _GlowOuter: number;
        _GlowPower: number;
        _MainTex: feng3d.Texture2D<feng3d.Texture2DEventMap>;
        _GradientScale: number;
        _TextureWidth: number;
        _TextureHeight: number;
        _ScaleX: number;
        _ScaleY: number;
        _Sharpness: number;
        _PerspectiveFilter: number;
        _VertexOffsetX: number;
        _VertexOffsetY: number;
        _MaskCoord: feng3d.Vector4;
        _MaskSoftnessX: number;
        _MaskSoftnessY: number;
        _ClipRect: feng3d.Vector4;
        _StencilReadMask: number;
        _WeightNormal: number;
        _WeightBold: number;
        _ShaderFlags: number;
        _ScaleRatioA: number;
        _ScaleRatioB: number;
